...
Usage:
  ...
  python3 tune_report.py /data/media/0/realdata_konik/<route>--0/rlog.zst
  python3 tune_report.py /data/media/0/realdata_konik/<route>--*/rlog.zst   # one route
  python3 tune_report.py /data/media/0/realdata_konik/*/rlog.zst            # whole day
